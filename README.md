...
- 📊 Building cloud-based data projects  
- 🧠 Learning AWS services (EC2, S3, IAM)  
- 🚀 Exploring how data systems scale in the cloud  
...
- 🔹 Learning AWS fundamentals (EC2, S3, IAM)
- 🔹 Practicing deployments on AWS
- 🔹 Working towards building scalable cloud projects
---
